...
public class US0010Api {
    ...
    public static void main(String[] args) throws JsonProcessingException {
        ...
        spec.pathParams("1", "api", "2", "appointments", "3", "1255");

        response = given().spec(spec).header("Authorization", "Bearer "+ generateToken("mark_twain","Mark.123"))
        ...
        Assert.assertEquals(1255, actualAppointment.getPatient().getId());
        Assert.assertEquals("2023-02-18T00:00:00Z", actualAppointment.getStartDate());
        Assert.assertEquals("2023-02-18T01:00:00Z", actualAppointment.getEndDate());
        Assert.assertEquals("UNAPPROVED",actualAppointment.getStatus());
