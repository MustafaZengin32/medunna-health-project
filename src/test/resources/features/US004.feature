...
Feature: Login page should accessible only with valid credentials
  ...
  @UI @UI004 @loginWrongPassword @Negative
  ...
  @UI @UI004 @loginWrongUsername @Negative
  ...
  @UI @UI004 @loginWrongUsernameAndWrongPassword @Negative
